...
namespace MLAgents
{
    ...
    public class TargetContact : MonoBehaviour
    {
        ...
        private const string TargetTag = "target"; // Tag on target object.
        ...
        {
            if (col.transform.CompareTag(TargetTag) || col.transform.parent.transform == target)
            {
                touchingTarget = true;
            }
        }
        ...
        void OnCollisionExit(Collision other)
        {
            ...
            if (other.transform.CompareTag(TargetTag) || other.transform.parent.transform == target)
            {
