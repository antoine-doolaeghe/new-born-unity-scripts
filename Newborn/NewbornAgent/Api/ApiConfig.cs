...
public class ApiConfig : ScriptableObject
{
  ...
  public string newBornGraphQlMutation = "mutation NewbornPost {createNewborn(input: {id: '$id^', name: '$name^', sex: '$sex^', newbornGenerationId: '$newbornGenerationId^'}) {id, name, generation{index}}}";
