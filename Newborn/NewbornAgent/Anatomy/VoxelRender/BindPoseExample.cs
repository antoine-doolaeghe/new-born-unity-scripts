...
public class BindPoseExample : MonoBehaviour
{
  void Start()
  {
    ...
    // Build basic mesh
    Mesh mesh = new Mesh();
    mesh.vertices = new Vector3[] { new Vector3(0, 0, 0), new Vector3(0, 0, 1), new Vector3(0, 1, 0) };
    ...
    BoneWeight[] weights = new BoneWeight[6];
    ...
    weights[3].weight0 = 1;
    weights[4].boneIndex0 = 2;
    weights[4].weight0 = 1;
    weights[5].boneIndex0 = 2;
    weights[5].weight0 = 1;
    ...
    bones[1] = new GameObject("Right").transform;
    ...
    bones[2] = new GameObject("Left").transform;
    bones[2].parent = transform;
    // Set the position relative to the parent
    bones[2].localRotation = Quaternion.identity;
    bones[2].localPosition = Vector3.zero;
